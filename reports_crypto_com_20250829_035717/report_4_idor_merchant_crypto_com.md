...
**Valor Estimado:** merchant.crypto.com00,000 - /api/v1/asset/transfer/history,000,000  
...
### Endpoint Afetado
- **URL:** https://merchant.crypto.com/api/v1/asset/transfer/history
- **Método:** GET
- **Status Code:** 200 OK
...
```bash
curl -s "https://merchant.crypto.com/api/v1/asset/transfer/history" \
...
curl "https://merchant.crypto.com/api/v1/asset/transfer/history"
...
curl "https://merchant.crypto.com/api/v1/asset/transfer/history?start_date=2025-01-01&end_date=2025-08-29"
...
curl "https://merchant.crypto.com/api/v1/asset/transfer/history" | jq '.data[].from_address'
...
**Faixa de Recompensa:** merchant.crypto.com00,000 - /api/v1/asset/transfer/history,000,000  
**Justificativa:** 
